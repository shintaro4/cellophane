...
//--------------------------------------------------------------
TwoVCO::TwoVCO() : frequency_(0.0f) {}

//--------------------------------------------------------------
// public methods
//--------------------------------------------------------------
float TwoVCO::convertFromNoteNumber(int note_number) {
  convert converter;
  return converter.mtof(note_number);
}

void TwoVCO::prepare(const TimeDiff timestamp, int duration, int note_number,
...
TwoVCO::Settings TwoVCO::getSettings() const {
  Settings settings = {
...
void TwoVCO::setSettings(TwoVCO::Settings settings) {
